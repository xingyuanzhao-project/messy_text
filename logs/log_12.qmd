...
1. Unit of analysis problem: the existing works are coded by features of victims, rather than spans or documents.
2. Training costs and lost knowledge
...
### Noisy Corpora Problem

- Error pages
- Website formats, such as navigation bars.
- Distractive information that are somewhat related but should not be there, such as suggested articles or comments from other users.
...
- Performance across models
  - Llama 3.1 8B Instruct (AWQ INT4) vs Gemma 3 12B IT (INT4 AWQ) vs Ministral 3 8B Instruct
- Performance between larger and smaller models
  - Llama 3.1 8B Instruct (AWQ INT4) vs Llama 3.1 70B Instruct (AWQ INT4)
  - Gemma 3 12B IT (INT4 AWQ) vs Gemma 3 27B IT (INT4 AWQ) (todo)
  - Ministral 3 8B Instruct vs Mistral 24B Instruct (todo)
...
- Evaluate large vs small models
